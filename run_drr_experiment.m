...
architecture = '/path/to/NNLocallyConnected_keras.py';
    ...
    while iTestFold <= nFolds
        ...
        while iParameter <= nParameters
            ...
            while iValFold < (nFolds-1)
                ...
                classifier = MSNeuralNetClassifier(...
                    'useValidationSet',0,...
                    'batchSize',batchSize,...
                    'epochs',n_epochs,...
                    'useTimeStamp',1,...
                    ...
                    'l2',0,...
                    'verbose',0,...
                    'trainingDataStd','model_input',...
                    'logitSens',parameter,...
                    'logitSqSens',parameter,...
                    'neuralNetArchitecture',architecture,...
                    'weightClasses',1,...
                    'neuralNetFile',...
                    ['/localdata/ChristianEtmann/BO_tests/c_',num2str(iCenter),'_test_',num2str(iTestFold),'_val_',num2str(iValFold),'_P_',num2str(iParameter),'.nnet'],...
                    'dataFile',...
                    ['/localdata/ChristianEtmann/BO_tests/c_',num2str(iCenter),'_test_',num2str(iTestFold),'_val_',num2str(iValFold),'_P_',num2str(iParameter),'_data.mat'],...
                    'resultFile',...
                    ['/localdata/ChristianEtmann/BO_tests/c_',num2str(iCenter),'_test_',num2str(iTestFold),'_val_',num2str(iValFold),'_P_',num2str(iParameter),'_result.mat']);
                
                model = classifier.trainModel(D, trainLabels);
                predictionLabels = model.classify(D, valLabels~=0);
                ...
                save(['BO_center_',num2str(iCenter),'.mat'],'experiment','iCenter','iParameter','iValFold','iTestFold','-v7.3')
            end
            experiment.center{iCenter}.testFold{iTestFold}.P{iParameter}.predictionLabels = ...
                MSLabelData({'B','O'},...
                experiment.center{iCenter}.testFold{iTestFold}.P{iParameter}.predictionLabels,...
            ...
            if experiment.center{iCenter}.testFold{iTestFold}.validationScore < score
                experiment.center{iCenter}.testFold{iTestFold}.validationScore = score;
        ...
        classifier = MSNeuralNetClassifier(...
            ...
            'verbose',0,...
            'trainingDataStd','model_input',...
            'logitSens',experiment.center{iCenter}.testFold{iTestFold}.bestParameter,...
            'logitSqSens',experiment.center{iCenter}.testFold{iTestFold}.bestParameter,...
            'neuralNetArchitecture',architecture,...
            'weightClasses',1,...
            'neuralNetFile',...
            ['/localdata/ChristianEtmann/BO_tests/T_c_',num2str(iCenter),'_test_',num2str(iTestFold),'.nnet'],...
            'dataFile',...
            ['/localdata/ChristianEtmann/BO_tests/T_c_',num2str(iCenter),'_test_',num2str(iTestFold),'_data.mat'],...
            'resultFile',...
            ['/localdata/ChristianEtmann/BO_tests/T_c_',num2str(iCenter),'_test_',num2str(iTestFold),'_result.mat']);
        
        model = classifier.trainModel(D, trainLabels);
        predictionLabels = model.classify(D, experiment.center{iCenter}.testFold{iTestFold}.testLabels);
